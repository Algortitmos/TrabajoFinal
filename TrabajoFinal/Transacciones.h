...
class Transacciones {
	...
	dato dat,cantidad;
	Dolares d;
	string tipoOperacion;    //Esto podria dar errores por no ponerle null al inicio
	dato resultado;
...
public:
	...
	string getTipoOperacion() { return tipoOperacion; }
	dato getResultado() { return resultado; }
	dato getCantidad() { return cantidad; }
